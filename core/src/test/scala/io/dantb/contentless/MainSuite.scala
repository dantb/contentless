...
// import io.dantb.contentless.appearance.{Control, Editor, EditorInterface, FieldControl, SidebarWidget}
// import io.dantb.contentless.appearance.codecs.*
...
// import io.dantb.contentless.codecs.implicits.*
...
// final case class AllMimeTypeGroupMedia(
//     archiveMedia: Media,
...
//     multiMedia: Media
// )
// object AllMimeTypeGroupMedia:
//   given codec: EntryCodec[AllMimeTypeGroupMedia] = (
...
//     ).required
//   ).imapN(AllMimeTypeGroupMedia.apply)(x =>
//     (
//       x.archiveMedia,
//       x.attachmentMedia,
//       x.audioMedia,
...
//       Person.PersonSidebar,
//       Set(
//         FieldControl("name", Person.NameControl.value, Set(HelpText("Enter your name"))),
//         FieldControl("bio", Control.BuiltIn.Markdown, Set.empty),
//         FieldControl("age", Control.BuiltIn.NumberEditor, Set.empty),
//         FieldControl(
//           "family",
//           Person.FamilyControl.value,
...
//     assertEquals(
//       EntryCodec[Person].entryCodec.schema,
//       expectedSchema
//     )
//     assertEquals(
//       EntryCodec[Person].entryCodec.write(person),
//       expectedJson
//     )
//     assertEquals(
//       EntryCodec[Person].entryCodec.read(expectedJson),
//       Right(person)
//     )
//     assertEquals(
//       EntryCodec[Person].editorInterface,
...
//     val entity = AllMimeTypeGroupMedia(
...
//     assertEquals(
//       EntryCodec[AllMimeTypeGroupMedia].entryCodec.schema,
//       expectedSchema
//     )
//     assertEquals(
//       EntryCodec[AllMimeTypeGroupMedia].entryCodec.write(entity),
//       expectedJson
//     )
//     assertEquals(
//       EntryCodec[AllMimeTypeGroupMedia].entryCodec.read(expectedJson),
//       Right(entity)
//     )
//   }
